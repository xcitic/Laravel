...
var update = __webpack_require__(40)("9e85698c", content, false);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addItem: function addItem() {
      ...
      var uri = 'http://localhost:7777/items';
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deleteItem: function deleteItem(id) {
            var uri = 'http://localhost:7777/items/' + id;
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getItem: function getItem() {
            ...
            var uri = 'http://localhost:7777/items/' + this.$route.params.id + '/edit';
            this.axios.get(uri).then(function (response) {
        ...
        updateItem: function updateItem() {
            ...
            var uri = 'http://localhost:7777/items/' + this.$route.params.id;
